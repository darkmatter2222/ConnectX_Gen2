...
| 18 | 2026-08-03 | MCTS Algorithms and Self-Play | 19 new verified claims (C083-C101): PUCT dominates MCTS selection (c_puct=1.0 train, 1.1 inference), FPU c_fpu=0.2, adaptive CPUCT, LCB, PCR (25% fast + 75% slow), Dirichlet alpha=0.8; MCTS simulation speeds documented; VERIFIED 48%→60% |
| 19 | 2026-08-03 | OFFICIAL_KAGGLE_RULES + External-Pool Batch | Kaggle kaggle-environments deep source analysis: overtime enforcement, agent timeout, board mutability, flat 1D array; 10 new VERIFIED (C102-C111); External-pool: 7×6 confirmed as only board with test evidence; 3 opening books decoded; TonyCWang data generation corrected; 7 new VERIFIED (C104-C106, C110-C113), 3 HYPOTHESIS (C107-C109); VERIFIED 66→68, SUPPORTED 4→5 |
| 20 | 2026-08-03 | NEURAL TRAINING AND HARDWARE | 3 NN architectures fully compared (ResNet katac4 vs MLP rowspire vs CNN marcpaulo15); 5 new VERIFIED (C114-C117), 1 SUPPORTED (C118); Kaggle T4 GPU specs verified; GPU MCTS on GRID A100 20.3M playouts/5s; VERIFIED 69→71 |
| 21 | 2026-08-03 | External-Pool Batch Synthesis (batch-00006) | 13 workers: 7 usable findings (board representation, MCTS variants, adversarial corrections, corpus audit), 5 stale, 1 API error, 1 premature; 2 new VERIFIED (C126, C127); 6 corrections (C044/C047 NEEDS_CORRECTION, C071 NEEDS_CORRECTION, C092 FALSIFIED, C097 CORRECTED, C099 UNVERIFIABLE); VERIFIED 73 |
| 22 | 2026-08-03 | T029 Connect 4 Engine Performance on Non-7x6 Boards | Complete board size matrix (4x4 to 11x11) from connect4.gamesolver.org; 8x8 P2 win (Tromp, book88); 9x6 P1 win (Nov 2005); 10x8 draw; 15x13/15x10 no results; Computational complexity O(R+C) disc placement, O(C*(R+C)) decision; Claims C128-C134 (6 VERIFIED, 1 HYPOTHESIS); VERIFIED 73→79, HYPOTHESIS 22→23 |
| 23 | 2026-08-03 | T017 Worker Result (batch-00008) — Asymmetric Eval Verification | Asymmetric eval source code verified: QveenCoder (S050) and nguyenthequang (S051) use identical window scoring (win:100K, near-win:100, opp near-win:-120, 1.2x opponent threat = proactive defense bias); C005 upgraded SUPPORTED→VERIFIED; C059 reconfirmed VERIFIED; Wikipedia page unchanged (15x13 solving unknown); Infinite Connect-Four solved: Draw; GitHub topic scans: no new repos; VERIFIED 79→80, SUPPORTED 5→4 |